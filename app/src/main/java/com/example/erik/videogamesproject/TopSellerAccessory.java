...
public class TopSellerAccessory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        accessoryAdapter = new FirebaseRecyclerAdapter<Accessory, LastReleaseAccessory.ViewHolderAccessory>(
            ...
            @Override
            protected void populateViewHolder(LastReleaseAccessory.ViewHolderAccessory viewHolder, Accessory model, final int position) {
